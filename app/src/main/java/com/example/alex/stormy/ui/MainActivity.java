...
import com.example.alex.stormy.weather.Current;
import com.example.alex.stormy.weather.Day;
import com.example.alex.stormy.weather.Forecast;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String HOURLY_FORCAST = "HOURLY_FORECAST";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDailyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               Intent intent = new Intent(v.getContext(), DailyForecastActivity.class);
    ...
    private void getForecast() {
        String apiKey = "577e2fa79fc7efced65c3656128dab80";
